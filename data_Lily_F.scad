// Data Set for Lily F Delta printer - 11 January 2015
// effector used HXM3
...
// Data for radius 131 and height between plate 500, called Lily F 131/500
...
/* Alternative dataset with same components Lily F 140/500 
//  -> usable diameter 190 mm H centre ~ 225mm, periphery 215mm - base slightly enlarged
// uncommenting the block will supersede former data  
Delta_name = str("Lily F 140/530 by PRZ");
beam_int_radius = 140;
arm_length = 206;
mini_angle = 22; 
basewd = 380;
...
module buildEffector() {
  if  ($chimera) {
    ...
    *color ("yellow")
    ...
    color (moving_color) {
      import("Lily_F_effector.stl");
      rotz(60) tsl (0,0,1)
        import("Lily_F_hotsup.stl");
    }  
   * tsl (0,0,25) {
...
module foot2() {
  ...
  difference() { 
     ...
     *    hull() {
      ...
      cubez (40,2,scr+5,  0,13,0); // top face
