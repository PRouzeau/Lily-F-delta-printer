...
$wallsup = 195;  // height of rod support
rod_base = 2; // distance between floor and rod base
$ht_tens = 175; // height of belt tensioner
...
motor_voffset = panelthk+25;

//stext = [str("Angle length: ",round(htotal+27+top_panelthk), " mm")];
stext = "-";

spoolsep_dp = 220; // depth of spool space - panel 15mm shorter
$spool_tsl = [270,220,452];
$spool_rot = [0,90,30];

boxpanelthk = 18; //closing panels, door, etc.
cover_panelthk =18; // cover over steppers
windoorwd = 200;
windoorht = 600;  
